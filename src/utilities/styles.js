...
export const styleCustomContainer = "bg-darkDark px-2 py-10 min-h-screen w-full";
...
export const styleButtonCard = "text-darkDark rounded-full p-2 transition-transform duration-300 ease-in-out transform hover:scale-105 hover:bg-green hover:text-darkDark hover:border-green text-center border border-darkDark  w-full cursor-pointer text-sm shadow-md";
