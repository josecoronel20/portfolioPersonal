export const styleCustomContainerTop = "bg-darkDark pt-24 px-5 pb-2 min-h-screen";
  
export const styleCustomContainer = "bg-darkDark px-5 py-10 min-h-screen w-full";
